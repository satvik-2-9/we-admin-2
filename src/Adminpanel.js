              ...
              {setup && (
                <Form className="ggs" onSubmit={handleSetup}>
                  <Row>
                    ...
                    <Button type="submit" variant="primary" className="sbtr">setup</Button>
            ...
            <Col>
              ...
              {send && (
                <Form className="ggs" onSubmit={handleSendMoney}>
                  ...
                  <Button variant="primary" type="submit" className="sbtr">
                    Send{" "}
                  </Button>{" "}
                </Form>
              )}{" "}
  ...
  function handleanalytics() {
    return (
        <div className="c">
            ...
            <div className="d">
                  <div>
                  <Button variant="dark" onClick={bringAnalytics}> Get Analytics </Button>  
                        {analytic && 
                            <Table striped bordered hover variant="dark" className="gp">
                <thead>
                  <tr>
